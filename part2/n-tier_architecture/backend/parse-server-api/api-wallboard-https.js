...
const config = {
  databaseURI: 'mongodb://wallboarduser:WB1qazxsw2@192.168.52.130:27017/wallboarddb',
  ...
  serverURL: 'https://172.26.244.151:' + apiport + '/api', // Don't forget to change to https if needed
  publicServerURL: 'https://172.26.244.151:' + apiport + '/api',
  liveQuery: {
